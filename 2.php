...
class User
{
    ...
    {
        $stmt = self::getInstance()->prepare("SELECT `id`, `name`, `lastName`, `from`, `age`, `settings` FROM Users WHERE age > :age_from LIMIT :limit");
        $stmt->execute(['age_from' => $ageFrom, 'limit' => $limit]);
